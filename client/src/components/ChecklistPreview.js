...
function ChecklistPreview({checklist, currentUser, followsRendered, setFollowsRendered, usersFollows, loaded, setLoaded}) {
    ...
    function handleUnfollow() {
        ...
        const targetedUnfollow = usersFollows.find(f => f.checklist_id == checklist.id && f.user_id == currentUser.id).id
